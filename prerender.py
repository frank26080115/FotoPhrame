...
class PreRenderer(object):
    ...
    def blend(self, img1_big, img1_small, img2_big, img2_small):
        alpha = 0
        buff = []
        done = False
    ...
    def task(self):
        ...
        self.wake_buffer = self.blend(self.parent.blank_img.copy(), self.parent.blank_img_small.copy(), img_large, img_small)
        if self.stop_event.is_set():
            print("pre-renderer got halt signal", flush=True)
            return
